...
function App() {
  ...
  if (screen === "game") {
    ...
    const stepDescriptions = [
      ...
      "Raad of de kaart hoger of lager is dan je eerste kaart.",
      "Raad of de kaart binnen of buiten je eerste twee kaarten valt.",
